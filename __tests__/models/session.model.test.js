...
describe('Session Model', () => {
    ...
    describe('Session Population', () => {
        it('should populate topic and user references', async () => {
            ...
            expect(populatedSession?.topic_id?.title).toBe('Basic Grammar');
            expect(populatedSession?.user_id?.phoneNumber).toBe('1234567890');
        });
    });
...
//# sourceMappingURL=session.model.test.js.map