...
describe('Topic Controller', () => {
  ...
  describe('createTopic', () => {
    it('should create a topic successfully', async () => {
      ...
      await topicController.createTopic(mockReq, mockRes as Response);
  ...
  describe('getTopicsGroupedByCategory', () => {
    ...
    it('should return topics grouped by category', async () => {
      ...
      await topicController.getTopicsGroupedByCategory(
        mockReq,
        mockRes as Response
      );
      ...
      const categories = callArg.data.map((g: any) => g.category);
    ...
    it('should include all topics in groups', async () => {
      ...
      const callArg = (mockRes.json as jest.Mock).mock.calls[0][0];
      const grammarGroup = callArg.data.find(
        (g: any) => g.category === 'Grammar'
      );
      expect(grammarGroup.topics.length).toBe(2);

      const vocabGroup = callArg.data.find(
        (g: any) => g.category === 'Vocabulary'
      );
  ...
  describe('getRecommendedTopic', () => {
    ...
    it('should return 401 if user not authenticated', async () => {
      ...
      await topicController.getRecommendedTopic(mockReq, mockRes as Response);
  ...
  describe('getTopicById', () => {
    ...
    it('should return topic by id', async () => {
      ...
      await topicController.getTopicById(mockReq, mockRes as Response);
